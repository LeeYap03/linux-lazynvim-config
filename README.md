...
| :------------------------------------------------------------------------------ | :-------------------------------------------------------------------- | :------------------------------------------------------------ |
| [catppuccin/nvim](https://github.com/catppuccin/nvim)                           | A highly aesthetic, cat-themed colorscheme; secondary colorscheme.    | [catppuccin.lua](lua/lee/plugins/colorschemes/catppuccin.lua) |
| [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim)               | A dark, elegant colorscheme based on the Tokyo Night VS Code theme.   | [tokyonight.lua](lua/lee/plugins/colorschemes/tokyonight.lua) |
| [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim)             | A collection of dark colorschemes with a focus on readability.        | [nightfox.lua](lua/lee/plugins/colorschemes/nightfox.lua)     |
...
| [ray-x/colorizer.lua](https://github.com/norcalli/nvim-colorizer.lua)           | Highlights color codes (like hex and RGB) in the buffer.              | [colorizer.lua](lua/lee/plugins/colorizer.lua)                |
